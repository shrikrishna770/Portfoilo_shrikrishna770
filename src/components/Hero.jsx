...
function Hero() {
  return (
    <section className="hero flex md:flex-row flex-col bg-black w-full text-white gap-8 sm:py-20 py-4 justify-center md:items-center items-start">
      <div className="md:w-[650px] p-4 flex flex-col gap-3">
      ...
      <div className="md:w-[650px] p-4"><img  className="rounded-2xl" src={profile} alt="" /></div>
    </section>
  );
}
